...
export default function Page() {
  ...
  return (
    <main className="bg-[#F6F7F9] px-15 rounded">
      <div className="p-5">
      ...
      <div className="w-3/5 ml-auto pl-10 py-20 flex justify-between items-center">
        <button className="py-2 px-4 bg-primary text-white rounded hover:cursor-pointer hover:opacity-90">
          Show more car
        </button>
        <p className="text-secondary-light text-md">120 Car</p>
      </div>
    </main>
  );
}
